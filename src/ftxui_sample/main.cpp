...
// configuration step. It creates a namespace called `pheps`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", pheps::cmake::project_name, pheps::cmake::project_version) };
